...
/*Time thread1*/
elapsed1 = (finish1.tv_sec - start1.tv_sec);elapsed1 += (finish1.tv_nsec - start1.tv_nsec) / 1000000000.0;
/*Time thread2*/
elapsed2 = (finish2.tv_sec - start2.tv_sec);elapsed2 += (finish2.tv_nsec - start2.tv_nsec) / 1000000000.0;
/*Time Total*/
...
*/
void print_message_function ( void *ptr ) www.jmest.org
JMESTN42350110 152
